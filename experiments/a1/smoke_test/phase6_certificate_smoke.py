...
from experiments.a1.synthetic_pomdp import ABORT, ACTION_NAMES, make_initial_belief, make_synthetic_pomdp
...
def main() -> None:
    ...
    cert_fullsup = compute_certificate(root_full, nd_full, model, unc_zero, S_full, Z_full, b0, H,)
    ...
    cert_p_z = compute_certificate(root_proj, nd_proj, model, unc_zero, S_in_proj, Z_in_proj, b0, H,)
    ...
    cert_p_r = compute_certificate(root_proj, nd_proj, model, unc_mid, S_in_proj, Z_in_proj, b0, H,)
